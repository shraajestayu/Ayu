...
@app.on_message(filters.command(BLOCK_COMMAND) & filters.user(OWNER_ID))
@language
...
@app.on_message(filters.command(UNBLOCK_COMMAND) & filters.user(OWNER_ID))
@language
...
@app.on_message(filters.command(BLOCKED_COMMAND) & filters.user(OWNER_ID))
@language
